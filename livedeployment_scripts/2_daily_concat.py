...
dailyaggregation_path = f'/home/ftpsensor_user/daily_compiled/aggregation/daily_Aggregation'
dailyaggregationSet = set(os.listdir(dailyaggregation_path))
dailycompiledfolder_path = '/home/ftpsensor_user/daily_compiled/dailyset'
...
def concatDailyStations(dateSet):
    ...
    dailysetfolder_path = f'/home/ftpsensor_user/daily_compiled/dailyset/{dateSet}'
    ...
    ##Concated path
    mergedpath = f'/home/ftpsensor_user/daily_compiled/aggregation/daily_Aggregation/{dateSet}/{dateSet}'
